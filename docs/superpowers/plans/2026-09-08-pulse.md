...
Якщо медіани не збіглися — звірити з довідковими числами специфікації §6–§7: telegram 14100 (23 пости з метрикою), crm_csv 4543.5 (16), rss `None`.
...
Expected: JSON із `posts_total: 59`, трьома блоками в `sources`, медіанами 14100 / null / 4543.5
...
| crm_csv: з метрикою / медіана | 16 / **4543.5** |
...
| медіани площадок crm_csv | cpa insider 1622, trafficdesk 4208.5, внутренний канал 6671.5 |
