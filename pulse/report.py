...
LEGEND = {
    ...
    "posts_total": "скільки постів потрапило в цей період",
    "rejected_on_import": "скільки рядків і файлів не вдалося прочитати; більше нуля "
                          "означає, що зріз неповний",
    "channel": "канал усередині свого джерела; між джерелами не порівнюваний — "
               "однакова назва в різних джерелах не означає той самий канал",
    "with_metric": "з якої кількості постів порахована медіана джерела",
    "metric_precision": "exact — число точне; rounded — джерело саме його округлило",
